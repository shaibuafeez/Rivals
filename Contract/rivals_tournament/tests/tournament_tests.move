...
module rivals_tournament::tournament_tests {
    ...
    fun test_register_nft_to_tournament() {
        ...
        test_scenario::next_tx(&mut scenario, USER1);
        {
            ...
            // Create more than the entry fee to test that the change is returned
            ...
            // Return objects - the payment should now have the entry fee deducted
            test_scenario::return_shared(tournament);
            test_scenario::return_to_sender(&scenario, nft);
            
            // Transfer the remaining payment to USER1 to properly handle it
